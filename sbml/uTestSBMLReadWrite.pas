...
'' + sLineBreak +
 ...
 'Render Information - id: renderInfotestNetwork' + sLineBreak +
...
'--  Render style id:textStyle_X0, RG:  Render group: Stoke width: -1, Stroke color: , fill color: , font size: 12, font style: normal, vTextAnchor: V_MIDDLE, hTextAnchor: H_MIDDLE, start head: , end head: , types: , roles: , Graphical Obj Ids:' + sLineBreak +
...
'--  Render style id:textStyle_S1, RG:  Render group: Stoke width: -1, Stroke color: , fill color: , font size: 12, font style: normal, vTextAnchor: V_MIDDLE, hTextAnchor: H_MIDDLE, start head: , end head: , types: , roles: , Graphical Obj Ids: ' + sLineBreak +
...
'--  Render style id:textStyle_S4, RG:  Render group: Stoke width: -1, Stroke color: , fill color: , font size: 12, font style: normal, vTextAnchor: V_MIDDLE, hTextAnchor: H_MIDDLE, start head: , end head: , types: , roles: , Graphical Obj Ids: ' + sLineBreak +
...
'--  Render style id:textStyle_S2, RG:  Render group: Stoke width: -1, Stroke color: , fill color: , font size: 12, font style: normal, vTextAnchor: V_MIDDLE, hTextAnchor: H_MIDDLE, start head: , end head: , types: , roles: , Graphical Obj Ids: ' + sLineBreak +
...
'--  Render style id:textStyle_S3, RG:  Render group: Stoke width: -1, Stroke color: , fill color: , font size: 12, font style: normal, vTextAnchor: V_MIDDLE, hTextAnchor: H_MIDDLE, start head: , end head: , types: , roles: , Graphical Obj Ids: ' + sLineBreak +
...
'--  Render style id:textStyle_X1, RG:  Render group: Stoke width: -1, Stroke color: , fill color: , font size: 12, font style: normal, vTextAnchor: V_MIDDLE, hTextAnchor: H_MIDDLE, start head: , end head: , types: , roles: , Graphical Obj Ids: ' + sLineBreak +
