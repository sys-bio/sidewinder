...
type
  ...
  private
    ...
    procedure drawGraph (canvas : TCanvas; x, y : TDataType; Size, startp, endp : integer);
...
begin
  ...
  canvas.Rectangle(0, 0, GraphScreenWidth, CanvasHeight);
  endp := 0; startp := 1; Size := 0;
end;


procedure TPlotGraph.drawGraph (canvas : TCanvas; x, y : TDataType; Size, startp, endp : integer);
