...
type
  ...
  TForm1 = class(TWebForm)
    StartLSODATestButton: TWebButton;
    procedure StartLSODATestButtonClick(Sender: TObject);
...
procedure TForm1.StartLSODATestButtonClick(Sender: TObject);
begin
...
function TForm1.getInitialValues(values: array of double): array of double;
var i, j: integer;
    val: array of double;
...
procedure TForm1.runTest(eqs: string; species: array of double; params: array of double);
var i, j: integer;
    stepSize: double;
    runTime: double;
    numSteps: Integer;
